...
void token::transfer( name    from,
                      ...
                      string  memo )
  {
    ...
    if ((circulating.amount/10000) >= 990000001) //divide by 10000 because sym precision multiplies the int by 10^(sym precision amount)
      { 
        stage = 1;
    ...
    if (stage != 21)
      { // no burning at 21
        ...
        action(permission_level{_self, "active"_n}, "sovsovsov223"_n, "userretire"_n, //burn the deflation amount and give detailed inline action for notification
...
void token::airburn(name account, asset quantity)
  {
    ...
    statstable.modify( st, same_payer, [&]( auto& s ) 
      
      {
        ...
        action(permission_level{_self, "active"_n}, "sovsovsov223"_n, "retire"_n, 
